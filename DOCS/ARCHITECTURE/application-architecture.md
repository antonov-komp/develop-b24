...
**Версия:** 2.0  
**Описание:** Полное описание архитектуры REST-приложения Bitrix24 с учетом всех реализованных функций
...
│       ├── access-control-debug-*.log # Отладочные логи управления правами
...
│       ├── department-check-*.log    # Логи проверки отделов
