...
**Дата завершения:** 2025-12-20 23:59 (UTC+3, Брест)  
**Статус:** Завершена  
**Приоритет:** Низкий  
...
- [x] Директория `tools/` создана ✅
- [x] Файл `checkserver.php` перемещен в `tools/` ✅
- [x] Пути к зависимостям обновлены ✅
- [x] Утилита работает после перемещения ✅
- [x] Документация обновлена ✅
- [x] Структура проекта соответствует новой организации ✅
...
- 2025-12-20 23:59 (UTC+3, Брест): Задача выполнена
  - ✅ Создана директория `tools/`
  - ✅ Файл `checkserver.php` перемещен в `tools/`
  - ✅ Обновлены пути к зависимостям (`require_once(__DIR__ . '/../crest.php')`)
