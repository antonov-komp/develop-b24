...
- [ ] Отладочные настройки условны (зависят от окружения)
- [ ] В production-режиме отладка отключена
- [ ] В development-режиме отладка включена
- [ ] Приложение работает корректно в обоих режимах
- [ ] Ошибки логируются в production (через `log_errors`)
- [ ] Документация обновлена с описанием настройки окружения
