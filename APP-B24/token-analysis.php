 ...
 * - Загружает Vue.js приложение на маршрут /token-analysis
 * 
...
try {
    ...
    // Загрузка Vue.js приложения на маршрут /token-analysis
    loadVueApp('/token-analysis');
    
} catch (\Throwable $e) {
    error_log('Fatal error in token-analysis.php: ' . $e->getMessage() . ' in ' . $e->getFile() . ':' . $e->getLine());
