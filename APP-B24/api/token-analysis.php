...
global $userService, $accessControlService, $configService, $logger, $apiService, $bitrix24Client;
...
function detectDomainRegion(string $domain): ?string
{
    ...
    // Для .bitrix24.by - это Беларусь, можно считать как ru регион
    if (strpos($domain, '.bitrix24.by') !== false) {
        return 'ru';
    }
